...
import {
  appearanceVars, badgeIconPath, badgeRendering, emptyHint, messagesToRemove, PIN_SLACK_PX,
  pinnedToBottom, platformIconPath, platformMarker, platformTag, barAlert, plainText, shouldDrop,
  sourceDotClass, statusDots, visibleBadges,
